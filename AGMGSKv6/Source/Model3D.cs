...
public class Model3D : DrawableGameComponent {
   ...
   public override void  Draw(GameTime gameTime) {
      ...
      foreach (Object3D obj3d in instance) {
          DrawHelper(this.model, gameTime, modelTransforms, obj3d);
          
          }        
        }

   protected void DrawHelper(Model modelX, GameTime gameTime, Matrix[] modelTransformsX, Object3D obj3d)
   {
       foreach (ModelMesh mesh in modelX.Meshes)
       {
           modelX.CopyAbsoluteBoneTransformsTo(modelTransformsX);
           foreach (BasicEffect effect in mesh.Effects)
           {
               ...
               effect.World = modelTransformsX[mesh.ParentBone.Index] * obj3d.Orientation;
           }
           mesh.Draw();
       }
       ...
       if (stage.DrawBoundingSpheres && IsCollidable)
       {
           foreach (ModelMesh mesh in stage.BoundingSphere3D.Meshes)
           {
               ...
               foreach (BasicEffect effect in mesh.Effects)
               {
                   ...
                   effect.View = stage.View;
                   effect.Projection = stage.Projection;
                   effect.World = obj3d.ObjectBoundingSphereWorld * modelTransformsX[mesh.ParentBone.Index];
               }
